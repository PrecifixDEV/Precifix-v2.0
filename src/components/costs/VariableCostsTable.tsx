                ...
                <Table>
                    <TableHeader>
                        <TableRow>
                            ...
                            <TableHead className="text-center text-slate-700 dark:text-slate-300">Data</TableHead>
                        ...
                        {costs.length > 0 ? (
                            costs.map((cost) => (
                                <TableRow key={cost.id}>
                                    ...
                                    <TableCell className="text-center text-slate-900 dark:text-slate-100">
                                        {cost.expense_date ? format(parseISO(cost.expense_date), 'dd/MM/yyyy') : '-'}
                                    </TableCell>
                            ...
                            <TableRow>
                                <TableCell colSpan={4} className="h-24 text-center text-slate-500 dark:text-slate-400">
                                    Nenhum custo variável cadastrado para este período.
                                </TableCell>
                            </TableRow>
                        )}
                    </TableBody>
