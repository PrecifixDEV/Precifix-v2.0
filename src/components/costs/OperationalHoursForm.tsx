    ...
    return (
        <div className="space-y-4 pt-4">
            ...
            <div className="space-y-3">
                {daysOfWeek.map(day => (
                    <div key={day.key} className="flex items-center gap-2">
                        ...
                        />
                        <Label htmlFor={day.key} className="w-12 text-zinc-700 dark:text-zinc-300">{day.label}:</Label>
            ...
            <div className="flex justify-end pt-4">
                <Button
                    onClick={onSaveHours}
                    className="bg-yellow-500 hover:bg-yellow-600 text-zinc-900 font-medium"
                    disabled={isSaving}
                >
                    {isSaving ? (
                        <>
