    ...
    return (
        <Card>
            ...
            <CardContent className="space-y-4">
                <div className="p-4 bg-slate-50 dark:bg-slate-800/50 rounded-lg border border-slate-200 dark:border-slate-800 space-y-2">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="p-4 rounded-lg bg-slate-50 dark:bg-slate-800/50 border border-green-500/20 shadow-sm">
                    ...
                    <div className="p-4 rounded-lg bg-slate-50 dark:bg-slate-800/50 border border-blue-500/20 shadow-sm">
                        <div className="flex items-center gap-2 mb-2">
