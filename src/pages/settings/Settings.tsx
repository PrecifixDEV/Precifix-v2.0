    ...
    return (
        <div className="container mx-auto p-4 md:p-8 max-w-4xl space-y-6 animate-in fade-in duration-500">
            ...
            <div className="hidden md:block mb-6">
                ...
                <p className="text-zinc-500 dark:text-zinc-400 mt-2">Gerencie as preferências e ajustes do sistema</p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {settingsItems.map((item) => (
                    <Link
                        key={item.href}
                        to={item.href}
                        className="group flex items-center justify-between p-6 bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-xl hover:shadow-md transition-all active:scale-[0.98]"
                    >
