...
-- Drop existing insert policy if it's too permissive or incorrect
...
-- This policy ensures that the 'user_id' column in the new quote matches the authenticated user's ID.
